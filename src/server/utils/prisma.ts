...
type TypeCodeMap<
  T extends TRPC_ERROR_CODE_KEY, 
  C extends string
> = Record<T,C>;

const makeErrorTypeCodeMap = <T extends TRPC_ERROR_CODE_KEY, C extends string>(
  map: TypeCodeMap<T, C>,
) => map;
...
/**
 * Determines if the provided error is a PrismaClientKnownRequestError of a specific type.
 *
